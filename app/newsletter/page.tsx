    ...
    <div style={{ minHeight: '100vh', background: '#09090d' }}>
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto', padding: '80px 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          <div style={{ width: '64px', height: '64px', background: 'linear-gradient(135deg, #7c3aed, #ec4899)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '40px' }}>
          {[{ icon: <Zap size={16} color="#ec4899" />, label: 'Weekly drops', value: 'Every Sunday' }, { icon: <Globe size={16} color="#7c3aed" />, label: 'Subscribers', value: '2,400+' }, { icon: <Code2 size={16} color="#06b6d4" />, label: 'No spam', value: 'Ever' }].map((s, i) => (
        ...
        {status === 'success' ? (
          <div style={{ padding: '32px', background: 'rgba(124,58,237,0.1)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '16px', textAlign: 'center' }}>
            <Check size={32} color="#7c3aed" style={{ margin: '0 auto 16px', display: 'block' }} />
          ...
          <div style={{ background: '#101018', border: '1px solid #1a1a2e', borderRadius: '16px', padding: '32px' }}>
            ...
            <button onClick={handleSubscribe}
              style={{ width: '100%', padding: '14px', background: 'linear-gradient(135deg, #7c3aed, #ec4899)', borderRadius: '10px', border: 'none', fontSize: '14px', fontWeight: 700, color: '#fff', cursor: 'pointer', fontFamily: 'inherit' }}>
